...
const navigation = {prevEl: ".product-list-carousel2 .swiper-button-prev", nextEl: ".product-list-carousel2 .swiper-button-next"};
...
const items = reactive([
  {id: 1, name: 'appliance', title: '家用电器', class: 'tab-pane fade show active', product_name_lg: '101.jpg', product_name: '61.jpg'},
  {id: 2, name: 'tea_towel', title: '茶巾', class: 'tab-pane fade', product_name_lg: '101.jpg', product_name: '81.jpg'},
  {id: 3, name: 'kitchen_towel', title: '厨房毛巾', class: 'tab-pane fade', product_name_lg: '101.jpg', product_name: '23.jpg'}
]);
